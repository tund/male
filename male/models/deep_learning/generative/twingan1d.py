...
class TwinGAN1D(GAN1D):
    """Twin Generative Adversarial Nets for 1D data
    """

    def __init__(self,
                 model_name='TwinGAN1D',
                 alpha=1.0,  # coefficient of d1
                 beta=1.0,  # coefficient of d2
                 **kwargs):
        super(TwinGAN1D, self).__init__(model_name=model_name, **kwargs)
        self.alpha = alpha
        self.beta = beta
    ...
    def disp_distribution(self, param, **kwargs):
        ...
        if 'ax' in kwargs:
            ...
            plt.title('1D Twin Generative Adversarial Nets', fontsize=28)
    ...
    def get_params(self, deep=True):
        out = super(TwinGAN1D, self).get_params(deep=deep)
        param_names = TwinGAN1D._get_param_names()
