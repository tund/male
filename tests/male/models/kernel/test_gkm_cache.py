...
from male.models.kernel.gkm_cache import CachedGKM
from male.callbacks import Display


def test_gkm_cache_visualization_2d(show=False, block_figure_on_end=False):
...
if __name__ == '__main__':
    ...
    # test_gkm_cache_visualization_2d(True,True)
