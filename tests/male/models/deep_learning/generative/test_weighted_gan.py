...
from male.models.deep_learning.generative import WeightedGAN
...
def test_weighted_gan_mnist(block_figure_on_end=False):
    ...
    model = WeightedGAN(model_name="WeightedGAN_MNIST",
                        alpha=0.5,
...
def test_weighted_gan_save_and_load(block_figure_on_end=False):
    ...
    model = WeightedGAN(model_name="WeightedGAN_MNIST_SaveLoad",
                        alpha=0.5,
                        num_z=10,  # set to 100 for a full run
                        img_size=(28, 28, 1),
                        batch_size=32,  # set to 64 for a full run
...
def test_weighted_gan_cifar10_inception_score(block_figure_on_end=False):
    ...
    filepath = os.path.join(model_dir(), "male/WeightedGAN/cifar10/checkpoints/"
    ...
    loss_display = Display(layout=(1, 1),
                           ...
                           filepath=[os.path.join(model_dir(), "male/WeightedGAN/cifar10/"
                                     ...
                                     os.path.join(model_dir(), "male/WeightedGAN/cifar10/"
    ...
    inception_score_display = Display(layout=(1, 1),
                                      ...
                                      filepath=[os.path.join(model_dir(), "male/WeightedGAN/"
                                                ...
                                                os.path.join(model_dir(), "male/WeightedGAN/"
                                                                          "cifar10/inception_score/"
